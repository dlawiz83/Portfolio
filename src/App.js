  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden relative">
      ...
      <section className="h-screen flex flex-col justify-center items-center text-center px-6 relative z-10">
        ...
        <a href="https://drive.google.com/file/d/1_uLP9m1yPVciaCYlgMbkmwF0izEM-Sya/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-2 px-4 py-2 border border-pink-500 text-pink-500 rounded-lg hover:bg-pink-500 hover:text-white transition">
